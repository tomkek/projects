...
#define USE_RPN_CALCULATOR         0 // Support for interfacing with steering and acceleration actors.
#define USE_PROTOCOL_EXAMPLE       1 // Support for interfacing with steering and acceleration actors.
